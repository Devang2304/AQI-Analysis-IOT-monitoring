...
export default function Map() {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGV2YW5nc3BpdDEyMyIsImEiOiJjbHZ0Zm1yc3gxMDFzMmpxemEzaXBoOWh5In0._vUhV40ydMwwyJqyzVc_nA';
  ...
  useEffect(() => {
    ...
    // add markers to map
    console.log("this is map data",data);
    if (data === null) {
      console.log("this is map data2",data);
      for (let parameter of data) {
        console.log("this is map data2",data);
        
        console.log("this sis parameter: ", parameter);
        // }
      ...
      for (let parameter of exampledata.data) {
        // }
        console.log("this is parameter: ", parameter.data);
        // data.forEach(function (parameter) {
        var el = document.createElement("section");
        var value = 0;
        let date = new Date(parameter.station.time);
